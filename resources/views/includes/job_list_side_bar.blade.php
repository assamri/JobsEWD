<div class="col-lg-3"> 
	...
	@endif
      ...
      <a href="javascript:void();" class="filterjobsnav">
      <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill="#5f6368"><path d="M440-160q-17 0-28.5-11.5T400-200v-240L168-736q-15-20-4.5-42t36.5-22h560q26 0 36.5 22t-4.5 42L560-440v240q0 17-11.5 28.5T520-160h-80Zm40-308 198-252H282l198 252Zm0 0Z"/></svg>
      {{__('Filter Jobs')}}
      </a>  


    <!-- Side Bar start -->
    <div class="sidebar" id="filterjobs">
        <input type="hidden" name="search" value="{{Request::get('search', '')}}"/>
        
        <a href="javascript:void();" class="close-filterjobs mb-3">
        <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill="#999"><path d="m336-280 144-144 144 144 56-56-144-144 144-144-56-56-144 144-144-144-56 56 144 144-144 144 56 56ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
        </a>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $country = App\Country::where('country_id','=',$country_id)->first();			  
                @endphp
                @if(null !== $country)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $city = App\City::where('city_id','=',$city_id)->first();			  
                @endphp
                @if(null !== $city)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $jobExperience = App\JobExperience::where('job_experience_id','=',$job_experience_id)->first();			  
                @endphp
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $jobType = App\JobType::where('job_type_id','=',$job_type_id)->first();
                @endphp
                @if(null !== $jobType)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $jobShift = App\JobShift::where('job_shift_id','=',$job_shift_id)->first();
                @endphp
                @if(null !== $jobShift)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $careerLevel = App\CareerLevel::where('career_level_id','=',$career_level_id)->first();
                @endphp
                @if(null !== $careerLevel)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $degreeLevel = App\DegreeLevel::where('degree_level_id','=',$degree_level_id)->first();
                @endphp
                @if(null !== $degreeLevel)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $gender = App\Gender::where('gender_id','=',$gender_id)->first();
                @endphp
                @if(null !== $gender)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $industry = App\Industry::where('id','=',$industry_id)->first();
                @endphp
                @if(null !== $industry)
                @php
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @php
                $jobSkill = App\JobSkill::where('job_skill_id','=',$job_skill_id)->first();
                @endphp
                @if(null !== $jobSkill)
