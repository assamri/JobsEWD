        ...
        <form action="{{route('job.list')}}" method="get">
            ...
            <div class="row"> 
                ...
                <div class="col-lg-9"> 
                    ...
                    <!-- Search List -->
                     <h3>{{ $jobs->total() }} Emplois Trouvés</h3>    
              ...
              <li class="col-lg-4 col-md-6 @if($job->is_featured == 1) featured @endif">
                ...
                @if(!(bool)$job->hide_salary)                    
                    <div class="salary mb-2">Salary: <strong>{{$job->salary_from .' '. $job->salary_currency}} - {{$job->salary_to .' '. $job->salary_currency}}/{{$job->getSalaryPeriod('salary_period')}}</strong></div>
                    @endif 
